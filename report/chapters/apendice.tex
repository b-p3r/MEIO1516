...
\label{appendix:c1}
\input{./report/table/tabela5}
  
\newpage
\input{./report/table/tabela6}

\subsection{Resultados obtidos com o \emph{supositorio.com}}
\label{appendix:c2}
\input{./report/fig/figura1}
\input{./report/fig/figura11}
\input{./report/fig/figura2}
\input{./report/fig/figura22}
